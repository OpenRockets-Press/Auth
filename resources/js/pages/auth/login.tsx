...
export default function Login({ status, canResetPassword }: Props) {
    return (
        <>
            ...
            <PasskeyVerify separator='Or use one of these to log in:'/>
...
Login.layout = {
    title: 'Log in to your Zero-Profit account',
    description: 'Enter your email and password below to log into your Zero-Profit account',
};
